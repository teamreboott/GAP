...
class TFLOP(PreTrainedModel):
    ...
    def __init__(
        ...
        self.decoder = MBARTDecoder(
            ...
            use_adjacent_penalty=self.config.use_adjacent_penalty,
            adjacent_penalty_config=self.config.adjacent_penalty_config,
            use_row_col_embedding=self.config.use_row_col_embedding,
            row_col_embedding_config=self.config.row_col_embedding_config,
        )
